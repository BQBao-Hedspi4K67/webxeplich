    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-white relative overflow-hidden p-4">
      ...
      <div className="w-full max-w-6xl relative z-10">
        ...
        <div className="flex flex-col items-center gap-4 mb-8 text-center">
          ...
          <div>
            <h1 className="text-slate-900 font-bold text-xl leading-snug">Học viện Kỹ thuật</h1>
            <h1 className="text-slate-900 font-bold text-xl leading-snug">và Công nghệ An ninh</h1>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            <div className="bg-gray-50 rounded-2xl border border-gray-300 p-6 shadow-lg">
              <h2 className="text-lg font-bold text-slate-900 mb-6">
                Lịch công tác hôm nay - {formatDDMM(new Date())}
                {todayHoliday && <span className="text-red-600 text-sm ml-2">({todayHoliday.ten})</span>}
              </h2>
              ...
              {loadingSchedules ? (
                ...
                <div className="max-h-[calc(100vh-360px)] overflow-y-auto overflow-x-auto rounded-xl border border-gray-300 pb-16">
                  <table className="w-full text-sm table-fixed">
                    <thead>
                      <tr className="border-b-2 border-gray-300 bg-gray-100">
                        <th className="px-4 py-3 text-left font-bold text-slate-900 w-[24%]">Ngày/Tháng/Năm</th>
                        <th className="px-4 py-3 text-left font-bold text-slate-900 w-[12%]">Buổi</th>
                        <th className="px-4 py-3 text-left font-bold text-slate-900 w-[16%]">Giờ</th>
                        <th className="px-4 py-3 text-left font-bold text-slate-900 w-[48%]">Chi tiết nội dung</th>
                      </tr>
                    </thead>
                    <tbody>
                      {(() => {
                        ...
                        return dayRows.map((row, rowIdx) => {
                          ...
                          return (
                            <tr key={`today-${rowIdx}`} className="border-b border-gray-200 bg-white hover:bg-gray-50 transition-colors">
                              {rowIdx === 0 && (
                                <td rowSpan={dayRows.length} className="px-4 py-3 bg-gray-100 font-bold text-slate-900 align-top border-r border-gray-300">
                                  <div>{dateLabel}</div>
                                  {todayHoliday && <div className="text-[10px] text-red-600 mt-0.5">{todayHoliday.ten || todayHoliday.holidayName}</div>}
                                </td>
                              )}
          ...
          <div className="lg:col-span-1">
            <div className="bg-gray-50 rounded-2xl border border-gray-300 p-8 shadow-lg">
              <div className="mb-8">
                <h2 className="text-2xl font-bold text-slate-900 text-center">Đăng nhập</h2>
              </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 bg-white border border-gray-300 rounded-lg text-slate-900 placeholder-slate-400 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-11 py-2.5 bg-white border border-gray-300 rounded-lg text-slate-900 placeholder-slate-400 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all"
                />
            ...
            <label className="flex items-center gap-2 cursor-pointer group pt-1">
              <div className={`w-4 h-4 rounded border flex items-center justify-center transition-all ${form.remember ? 'bg-blue-600 border-blue-600' : 'border-slate-300 group-hover:border-slate-400'}`}
            ...
            {/* Error */}
            {error && (
              <div className="flex items-center gap-2 px-4 py-3 bg-red-100 border border-red-300 rounded-lg mt-4">
            ...
            <button type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 py-2.5 bg-blue-600 hover:bg-blue-700 disabled:bg-blue-400 text-white font-semibold rounded-lg transition-all duration-300 shadow-lg shadow-blue-600/30 hover:shadow-blue-700/40 active:translate-y-0 mt-6">
              {loading ? (
